<html>
    ...
    {}
	 ...
	 //echo $count1;
	 //echo $count2;
	 //echo "<b><font color=white>YES: ".number_format(($perc1*100),2) ."%</font></b><br/>";
	 //echo "  ";
	 //echo"<b><font color=white>NO: ".number_format(($perc2*100),2)."%</font></b><br/>";
	 
	  //echo "<b><font color=white>Total votes: ".$count3."</font></b><br/>";
	  //echo "<b><font color=white>IP ADDRESS:".$ipad."</font></b>";
	}}}
?>
	<head>
